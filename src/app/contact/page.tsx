...
export default function ContactPage() {
  return (
    <div className="relative min-h-screen overflow-hidden text-white" style={{ backgroundColor: 'var(--surface-primary)' }}>
      <BackgroundAnimation />
      <Navigation />
          ...
          {contactChannels.map((channel) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="rounded-2xl p-3 text-white" style={{ backgroundColor: 'var(--surface-card)' }}>{channel.icon}</div>
