...
export default function BulkPlayerUpload({ onSuccess }: BulkPlayerUploadProps) {
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      a.href = url;
      a.download = 'master_players_template.xlsx';
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold text-white">Bulk Player Upload</h3>
        <button
      ...
      {uploading && (
        <div className="mt-4 bg-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white">Processing file and importing players...</span>
          </div>
        </div>
      )}
      ...
      {result && (
        <div className="mt-4 bg-gray-700 rounded-lg p-4">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm">
                <p className="text-gray-300">
                  <span className="font-medium text-green-400">{result.imported}</span> players imported successfully
                </p>
                <p className="text-gray-300">
          ...
          {result.duplicates && result.duplicates.length > 0 && (
            <div className="mt-4 border-t border-gray-600 pt-3">
              <h5 className="text-yellow-400 font-medium mb-2 text-sm">Duplicates Skipped:</h5>
              <div className="max-h-40 overflow-y-auto space-y-1">
