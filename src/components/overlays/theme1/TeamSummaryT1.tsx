...
// Layout constants — mirrors SoldPlayersSummaryT1 exactly
const CANVAS_W = 1920;
const CANVAS_H = 1080;
...
const TeamSummaryT1: React.FC<TeamSummaryT1Props> = ({ teams, tournament, isExiting = false }) => {
